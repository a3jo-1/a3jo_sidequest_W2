...
let blob3 = {
  ...
  wobble: 5, // Edge deformation amount
  wobbleFreq: 0.6,
  ...
  // Movement tuning
  accel: 0.35, // Horizontal acceleration
  maxRun: 2.5, // Maximum horizontal speed
  gravity: 0.65, // Downward force
  jumpV: -10.0, // Initial jump impulse

  // State
  onGround: false, // True when standing on a platform

  // Friction
  frictionAir: 0.98, // Light friction in air
